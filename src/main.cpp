/*
  PocketGo2 Test
  Test the status of console PocketGo2:
  · Buttons
  · Sticks
  · Sound
  · Rumble
...
// graphics
SDL_Surface *pg2_back;
SDL_Surface *pg2_padup;
SDL_Surface *pg2_padup_press;
SDL_Surface *pg2_paddown;
SDL_Surface *pg2_paddown_press;
SDL_Surface *pg2_padleft;
SDL_Surface *pg2_padleft_press;
SDL_Surface *pg2_padright;
SDL_Surface *pg2_padright_press;
SDL_Surface *pg2_power;
SDL_Surface *pg2_power_press;
SDL_Surface *pg2_select;
SDL_Surface *pg2_select_press;
SDL_Surface *pg2_start;
SDL_Surface *pg2_start_press;
SDL_Surface *pg2_menu;
SDL_Surface *pg2_menu_press;
SDL_Surface *pg2_a;
SDL_Surface *pg2_a_press;
SDL_Surface *pg2_b;
SDL_Surface *pg2_b_press;
SDL_Surface *pg2_x;
SDL_Surface *pg2_x_press;
SDL_Surface *pg2_y;
SDL_Surface *pg2_y_press;
SDL_Surface *pg2_l1;
SDL_Surface *pg2_l1_press;
SDL_Surface *pg2_l2;
SDL_Surface *pg2_l2_press;
SDL_Surface *pg2_r1;
SDL_Surface *pg2_r1_press;
SDL_Surface *pg2_r2;
SDL_Surface *pg2_r2_press;
SDL_Surface *pg2_voldown;
SDL_Surface *pg2_voldown_press;
SDL_Surface *pg2_volup;
SDL_Surface *pg2_volup_press;
SDL_Surface *pg2_stick;
SDL_Surface *pg2_stick_mov;
SDL_Surface *pg2_stick_press;
...
SDL_Surface *pg2_battery;
SDL_Surface *pg2_battery2;
...
void init_game()
{
  ...
  // Graphics
  load_imgalpha("media/pg2_back.png",pg2_back);
  load_imgalpha("media/pg2_stick.png",pg2_stick);
  load_imgalpha("media/pg2_stick_moved.png",pg2_stick_mov);
  load_imgalpha("media/pg2_stick_pressed.png",pg2_stick_press);
  load_imgalpha("media/pg2_button_power.png",pg2_power);
  load_imgalpha("media/pg2_button_power_pressed.png",pg2_power_press);
  load_imgalpha("media/pg2_button_s.png",pg2_select);
  load_imgalpha("media/pg2_button_s_pressed.png",pg2_select_press);
  load_imgalpha("media/pg2_button_s.png",pg2_start);
  load_imgalpha("media/pg2_button_s_pressed.png",pg2_start_press);
  load_imgalpha("media/pg2_button_s.png",pg2_menu);
  load_imgalpha("media/pg2_button_s_pressed.png",pg2_menu_press);
  load_imgalpha("media/pg2_button_vol1.png",pg2_voldown);
  load_imgalpha("media/pg2_button_vol1_pressed.png",pg2_voldown_press);
  load_imgalpha("media/pg2_button_vol2.png",pg2_volup);
  load_imgalpha("media/pg2_button_vol2_pressed.png",pg2_volup_press);
  load_imgalpha("media/pg2_button_up.png",pg2_padup);
  load_imgalpha("media/pg2_button_up_pressed.png",pg2_padup_press);
  load_imgalpha("media/pg2_button_down.png",pg2_paddown);
  load_imgalpha("media/pg2_button_down_pressed.png",pg2_paddown_press);
  load_imgalpha("media/pg2_button_left.png",pg2_padleft);
  load_imgalpha("media/pg2_button_left_pressed.png",pg2_padleft_press);
  load_imgalpha("media/pg2_button_right.png",pg2_padright);
  load_imgalpha("media/pg2_button_right_pressed.png",pg2_padright_press);
  load_imgalpha("media/pg2_button_l1.png",pg2_l1);
  load_imgalpha("media/pg2_button_l1_pressed.png",pg2_l1_press);
  load_imgalpha("media/pg2_button_l2.png",pg2_l2);
  load_imgalpha("media/pg2_button_l2_pressed.png",pg2_l2_press);
  load_imgalpha("media/pg2_button_r1.png",pg2_r1);
  load_imgalpha("media/pg2_button_r1_pressed.png",pg2_r1_press);
  load_imgalpha("media/pg2_button_r2.png",pg2_r2);
  load_imgalpha("media/pg2_button_r2_pressed.png",pg2_r2_press);
  load_imgalpha("media/pg2_button_a.png",pg2_a);
  load_imgalpha("media/pg2_button_a_pressed.png",pg2_a_press);
  load_imgalpha("media/pg2_button_b.png",pg2_b);
  load_imgalpha("media/pg2_button_b_pressed.png",pg2_b_press);
  load_imgalpha("media/pg2_button_x.png",pg2_x);
  load_imgalpha("media/pg2_button_x_pressed.png",pg2_x_press);
  load_imgalpha("media/pg2_button_y.png",pg2_y);
  load_imgalpha("media/pg2_button_y_pressed.png",pg2_y_press);
  ...
  load_imgalpha("media/info_menu.png",info_menu);
  ...
  load_imgalpha("media/battery.png",pg2_battery);
  load_imgalpha("media/battery2.png",pg2_battery2);
  ...
  joy1.button=pg2_stick;
  joy1.button_pressed=pg2_stick_press;
  joy1.button_moved=pg2_stick_mov;
  joy1.x=rg_x+11;
  joy1.y=rg_y+50; //26
  joy1.moved_time=-3000;
  joy1.pressed_time=-3000;
  padup.button=pg2_padup;
  padup.button_pressed=pg2_padup_press;
  padup.x=rg_x+12;
  padup.y=rg_y+20;  //45
  padup.moved_time=-3000;
  padup.pressed_time=-3000;
  paddown.button=pg2_paddown;
  paddown.button_pressed=pg2_paddown_press;
  paddown.x=padup.x;
  paddown.y=padup.y+14; //rg_y+40;  //59
  paddown.moved_time=-3000;
  paddown.pressed_time=-3000;
  padleft.button=pg2_padleft;
  padleft.button_pressed=pg2_padleft_press;
  padleft.x=rg_x+5;
  padleft.y=padup.y+7; //rg_y+33;
  padleft.moved_time=-3000;
  padleft.pressed_time=-3000;
  padright.button=pg2_padright;
  padright.button_pressed=pg2_padright_press;
  padright.x=rg_x+19;
  padright.y=padup.y+7; //rg_y+33;
  padright.moved_time=-3000;
  padright.pressed_time=-3000;
  btna.button=pg2_a;
  btna.button_pressed=pg2_a_press;
  btna.x=rg_x+126;
  btna.y=rg_y+27;
  btna.moved_time=-3000;
  btna.pressed_time=-3000;
  btnb.button=pg2_b;
  btnb.button_pressed=pg2_b_press;
  btnb.x=rg_x+119;
  btnb.y=rg_y+36;
  btnb.moved_time=-3000;
  btnb.pressed_time=-3000;
  btnx.button=pg2_x;
  btnx.button_pressed=pg2_x_press;
  btnx.x=rg_x+119;
  btnx.y=rg_y+20;
  btnx.moved_time=-3000;
  btnx.pressed_time=-3000;
  btny.button=pg2_y;
  btny.button_pressed=pg2_y_press;
  btny.x=rg_x+111;
  btny.y=rg_y+28;
  btny.moved_time=-3000;
  btny.pressed_time=-3000;
  btnsel.button=pg2_select;
  btnsel.button_pressed=pg2_select_press;
  btnsel.x=rg_x+110;
  btnsel.y=rg_y+55;
  btnsel.moved_time=-3000;
  btnsel.pressed_time=-3000;
  btnst.button=pg2_start;
  btnst.button_pressed=pg2_start_press;
  btnst.x=rg_x+110;
  btnst.y=rg_y+64;
  ...
  btnmenu.pressed_time=-3000;
  btnpw.button=pg2_power;
  btnpw.button_pressed=pg2_power_press;
  btnpw.x=rg_x+40;
  btnpw.y=rg_y+3;
  btnpw.moved_time=-3000;
  btnpw.pressed_time=-3000;
  btnvu.button=pg2_volup;
  btnvu.button_pressed=pg2_volup_press;
  btnvu.x=rg_x+79;
  btnvu.y=rg_y+3;
  btnvu.moved_time=-3000;
  btnvu.pressed_time=-3000;
  btnvd.button=pg2_voldown;
  btnvd.button_pressed=pg2_voldown_press;
  btnvd.x=rg_x+79;
  btnvd.y=rg_y+3;
  btnvd.moved_time=-3000;
  btnvd.pressed_time=-3000;
  btnl1.button=pg2_l1;
  btnl1.button_pressed=pg2_l1_press;
  btnl1.x=rg_x+2;
  btnl1.y=rg_y+5;
  btnl1.moved_time=-3000;
  btnl1.pressed_time=-3000;
  btnl2.button=pg2_l2;
  btnl2.button_pressed=pg2_l2_press;
  btnl2.x=rg_x+20;
  btnl2.y=rg_y+3;
  btnl2.moved_time=-3000;
  btnl2.pressed_time=-3000;
  btnr1.button=pg2_r1;
  btnr1.button_pressed=pg2_r1_press;
  btnr1.x=rg_x+123;
  btnr1.y=rg_y+5;
  btnr1.moved_time=-3000;
  btnr1.pressed_time=-3000;
  btnr2.button=pg2_r2;
  btnr2.button_pressed=pg2_r2_press;
  btnr2.x=rg_x+109;
  btnr2.y=rg_y+3;
...
void end_game()
{
  ...
  // Free graphics
  if(pg2_back)
    SDL_FreeSurface(pg2_back);
  if(pg2_power)
    SDL_FreeSurface(pg2_power);
  if(pg2_power_press)
    SDL_FreeSurface(pg2_power_press);
  if(pg2_select)
    SDL_FreeSurface(pg2_select);
  if(pg2_select_press)
    SDL_FreeSurface(pg2_select_press);
  if(pg2_start)
    SDL_FreeSurface(pg2_start);
  if(pg2_start_press)
    SDL_FreeSurface(pg2_start_press);
  if(pg2_stick)
    SDL_FreeSurface(pg2_stick);
  if(pg2_stick_mov)
    SDL_FreeSurface(pg2_stick_mov);
  if(pg2_stick_press)
    SDL_FreeSurface(pg2_stick_press);
  if(pg2_voldown)
    SDL_FreeSurface(pg2_voldown);
  if(pg2_voldown_press)
    SDL_FreeSurface(pg2_voldown_press);
  if(pg2_volup)
    SDL_FreeSurface(pg2_volup);
  if(pg2_volup_press)
    SDL_FreeSurface(pg2_volup_press);
  if(pg2_l1)
    SDL_FreeSurface(pg2_l1);
  if(pg2_l1_press)
    SDL_FreeSurface(pg2_l1_press);
  if(pg2_l2)
    SDL_FreeSurface(pg2_l2);
  if(pg2_l2_press)
    SDL_FreeSurface(pg2_l2_press);
  if(pg2_r1)
    SDL_FreeSurface(pg2_r1);
  if(pg2_r1_press)
    SDL_FreeSurface(pg2_r1_press);
  if(pg2_r2)
    SDL_FreeSurface(pg2_r2);
  if(pg2_r2_press)
    SDL_FreeSurface(pg2_r2_press);
  if(pg2_padup)
    SDL_FreeSurface(pg2_padup);
  if(pg2_padup_press)
    SDL_FreeSurface(pg2_padup_press);
  if(pg2_paddown)
    SDL_FreeSurface(pg2_paddown);
  if(pg2_paddown_press)
    SDL_FreeSurface(pg2_paddown_press);
  if(pg2_padleft)
    SDL_FreeSurface(pg2_padleft);
  if(pg2_padleft_press)
    SDL_FreeSurface(pg2_padleft_press);
  if(pg2_padright)
    SDL_FreeSurface(pg2_padright);
  if(pg2_padright_press)
    SDL_FreeSurface(pg2_padright_press);
  if(pg2_a)
    SDL_FreeSurface(pg2_a);
  if(pg2_a_press)
    SDL_FreeSurface(pg2_a_press);
  if(pg2_b)
    SDL_FreeSurface(pg2_b);
  if(pg2_b_press)
    SDL_FreeSurface(pg2_b_press);
  if(pg2_x)
    SDL_FreeSurface(pg2_x);
  if(pg2_x_press)
    SDL_FreeSurface(pg2_x_press);
  if(pg2_y)
    SDL_FreeSurface(pg2_y);
  if(pg2_y_press)
    SDL_FreeSurface(pg2_y_press);
  if(pg2_battery)
    SDL_FreeSurface(pg2_battery);
  if(pg2_battery2)
    SDL_FreeSurface(pg2_battery2);
...
void draw_game()
{
  ...
  dest.y=rg_y;
  if(pg2_back)
    SDL_BlitSurface(pg2_back,NULL,screen,&dest);

  // joystick1
  dest.x=joy1.x+SDL_JoystickGetAxis(joystick,0)/5461;   // axis value (-32767,32768), I want draw it with 6 pixels displace
  dest.y=joy1.y+SDL_JoystickGetAxis(joystick,1)/5461;
  ...
  dest.x=btnmenu.x;
  dest.y=btnmenu.y;
  if((time-btnmenu.pressed_time)<3000)
  {
    if(btnmenu.button_pressed)
      SDL_BlitSurface(btnmenu.button_pressed,NULL,screen,&dest);
    dest.x=rg_x+116;
    dest.y=rg_y+46;
    if(info_menu)
      SDL_BlitSurface(info_menu,NULL,screen,&dest);
  }
  else
  {
    if(btnmenu.button)
      SDL_BlitSurface(btnmenu.button,NULL,screen,&dest);
  }
  // button select
  dest.x=btnsel.x;
  dest.y=btnsel.y;
  ...
  dest.y=rg_y+20;
  if(pg2_battery)
    SDL_BlitSurface(pg2_battery,NULL,screen,&dest);
  ...
  if(battery_charging)
    if(pg2_battery2)
      SDL_BlitSurface(pg2_battery2,NULL,screen,&dest);
